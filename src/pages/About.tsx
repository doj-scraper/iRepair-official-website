...
const About = () => (
  <MainLayout>
    <section className="relative overflow-hidden gradient-hero">
      {/* Pale-yellow accent stripe at the top */}
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="container relative py-16 text-primary-foreground md:py-24">
        <p className="text-[11px] font-bold uppercase tracking-[0.14em] opacity-75">About us</p>
...
// Avoid static prerendering for this page during migration — render at request time
